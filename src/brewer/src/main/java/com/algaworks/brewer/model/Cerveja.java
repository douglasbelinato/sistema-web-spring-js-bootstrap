...
public class Cerveja {
	...
	@Size(max = 50, message = "Descrição deve ter entre 1 e 50 caracteres.")
	...
	@DecimalMax(value = "100.0", message = "O valor da comissão deve ser menor ou igual a 100")
	...
	// Aula 11.5. Callbacks JPA - Salvando SKU com caixa alta
