...
public class ClientesController {
	...
	// @RequestMapping(value = "/novo", method = RequestMethod.POST) // Posso usar assim
	@PostMapping(value = "/novo") // Ou assim
	public ModelAndView cadastrar(@Valid Cliente cliente, BindingResult result, RedirectAttributes redirectAttributes) { // poderia usar @Validaded do Spring também
		if (result.hasErrors()) {
			return novo(cliente);
		}
